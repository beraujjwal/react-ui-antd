...
import { AppNumberInput } from '../../../../../../common/inputs/numbers/AppNumberInput';
...
export const CenterText = styled(AppTypography.Text)`
  position: absolute;
  top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);
...
export const NumberInput = styled(AppNumberInput)`
  width: unset;
